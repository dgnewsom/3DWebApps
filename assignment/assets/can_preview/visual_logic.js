 ...
 * Thu Feb 17 2022 11:40:37 GMT+0000 (Greenwich Mean Time)
...
eventHTMLElem('click', 'coke_button', true, function(event) {
  brand = 0;
  UpdateDisplay();
});
eventHTMLElem('click', 'sprite_button', true, function(event) {
  brand = 1;
  UpdateDisplay();
});
eventHTMLElem('click', 'pepper_button', true, function(event) {
  brand = 2;
  UpdateDisplay();
});
eventHTMLElem('click', 'fanta_button', true, function(event) {
  brand = 3;
  UpdateDisplay();
});
...
eventHTMLElem('click', 'wire_button', true, function(event) {
  WireFrame();
});
eventHTMLElem('click', 'spin_button', true, function(event) {
...
eventHTMLElem('click', 'can_button', true, function(event) {
  CansActive = true;
  BottlesActive = false;
  CupsActive = false;
  UpdateDisplay();
});
eventHTMLElem('click', 'bottle_button', true, function(event) {
  CansActive = false;
  BottlesActive = true;
  CupsActive = false;
  UpdateDisplay();
});
eventHTMLElem('click', 'cup_button', true, function(event) {
  CansActive = false;
  BottlesActive = false;
  CupsActive = true;
  UpdateDisplay();
