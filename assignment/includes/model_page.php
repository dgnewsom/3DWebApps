        ...
        <div class="col-sm-6">
            <div class="card text-left">
                <div class="card-header main-colour">
                    <button class="btn" id="coke_button" onclick="showModel('coke')"></button>
                    <button class="btn" id="sprite_button" onclick="showModel('sprite')"></button>
                    <button class="btn" id="pepper_button" onclick="showModel('pepper')"></button>
                    <button class="btn" id="fanta_button" onclick="showModel('fanta')"></button>
                </div>
                <div class="card-body">
                    <!--Model-->
                    <div class="model3D">
                ...
                <div class="card model-type-card">
                    ...
                    <div class="card-body">
                        <div class="card-text">
                            ...
                            <a href="#" class="btn" id = "can_button"  onclick="javascript:set_model_type('can')"></a>
                            <a href="#" class="btn" id = "bottle_button"  onclick="javascript:set_model_type('bottle')"></a>
                            <a href="#" class="btn" id = "cup_button"  onclick="javascript:set_model_type('cup')"></a>
                        </div>
                    </div>
                </div>
            </div>
