<div id="deeper_understanding">
    ...
    <ul>
        <li>Originally developed a full app to embed using Verge3D (<a href="javascript:showVerge3d()">as shown here</a>) to better show the modelling involved (it rendered better than .x3d). <br/>However after discussion with lecturer agreed that it was more in the spirit of the assignment to use .x3d format.</li>
